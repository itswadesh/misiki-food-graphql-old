...
//     }
// }
// export const constructQuery = async ({ q, search, predicate, forAdmin }: any) => {
...
//             product.variants.map((v:VariantDocument) => {
...
//     }
// }
// export const checkProductIdV = async (pid:string, vid:string, promotions:any) => {
//     try {
